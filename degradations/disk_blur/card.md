...
weights following a flat disk of uniform weight inside the radius and zero outside:
...
Its transfer function is a Bessel function, which like the box kernel changes sign, so some wavenumbers return inverted.
